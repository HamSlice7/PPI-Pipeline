...
def calc_sasa(pdb_file_path, residue):
   """
   Calculates the solvent accessibility surface area (SASA) of a active site residue for a peptidase
   ...
   sasa_active_site_residue = result.residueAreas()["A"][str(residue)].total
